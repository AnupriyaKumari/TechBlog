<%-- 
    Document   : profile
    Created on : 06-Dec-2021, 6:51:41 am
    Author     : ANUPRIYA
--%>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#"><span class="fa fa-home"></span> The Coding Hub<span class="sr-only">(current)</span></a>
                    </li>
                    <!--            <li class="nav-item">
