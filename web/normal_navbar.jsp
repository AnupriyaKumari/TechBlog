<%-- 
    ...
    Created on : 05-Dec-2021, 1:44:01 pm
    Author     : ANUPRIYA
--%>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="login_page.jsp"><span class="fa fa-home"></span> The Coding Hub<span class="sr-only">(current)</span></a>
            </li>
<!--            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="login_page.jsp">Programming Language</a>
                    <a class="dropdown-item" href="login_page.jsp">Data Structures</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="login_page.jsp">Projects</a>
                </div>
            </li>
<!--             <li class="nav-item">
